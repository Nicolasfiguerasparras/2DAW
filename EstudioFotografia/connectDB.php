<?php 
    function connectDB() {
        $db = mysqli_connect("127.0.0.1", "root", "", "proyecto"); //Aquí hay que introducir el nombre de la base de datos
        if (!$db) {
    ...
    // Creamos la función getNextIdOf para sacar el ID de cualquier tabla introducida por parámetros.
