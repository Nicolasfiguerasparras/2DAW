...
response.write("<h3>Busqueda de una reserva</h3>")
 response.write("<form action='buscarReservaUsuario.asp' method='POST' name='form'>")
...
sSQL="SELECT distinct cl.codigo, cl.nombre, re.* FROM cliente cl, vehiculo ve , reservas re where cl.codigo=re.cliente and ve.matricula=re.vehiculo and cl.codigo="&codigoCliente&" and (cl.nombre like '"&buscar&"' or ve.matricula like '"&buscar&"' or re.inicio like '"&buscar&"' or re.fin like '"&buscar&"')"
